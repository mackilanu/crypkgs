...
/* Define to 1 if you have the declaration of `__UT_HOSTSIZE', and to 0 if you
   don't. */
#define HAVE_DECL___UT_HOSTSIZE 1
...
#define HAVE_SD_SESSION_GET_LEADER 1
...
#define HAVE_SIGINFO_T_SI_INT 1
...
#define HAVE_UT_HOSTSIZE_IN_UTMPX 1
...
#define PACKAGE_STRING "procps-ng 4.0.4"
